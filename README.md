...
[![DOI](https://img.shields.io/badge/DOI-10.5281%2Fzenodo.22032373-blue)](https://doi.org/10.5281/zenodo.22032373)
...
```
results/
  phase_a/                 5 JSONs  — per-row measurement (A1, A2, A3, A4, A5)
